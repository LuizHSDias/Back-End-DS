...
INSERT INTO tb_categoria(descricao, tipo) VALUES ('Contas residenciais', 'Fixo');
INSERT INTO tb_categoria(descricao, tipo) VALUES ('Moradia', 'Fixo');
INSERT INTO tb_categoria(descricao, tipo) VALUES ('Educação', 'Fixo');
...
INSERT INTO tb_categoria(descricao, tipo) VALUES ('Freelancer', 'Variável');

INSERT INTO tb_despesa(descricao, data_vencimento, data_pagamento, situacao, valor, id_usuario, id_categoria) VALUES ('Internet', '2025-06-05', '2025-06-05', 'Pago', 1200.00, 1, 1);
INSERT INTO tb_despesa(descricao, data_vencimento, data_pagamento, situacao, valor, id_usuario, id_categoria) VALUES ('Conta de Água', '2025-06-10', '2025-06-09', 'Pago', 85.75, 2, 2);
...
INSERT INTO tb_receita(data_entrada, id_usuario, id_categoria, valor) VALUES ('2025-06-09', 4, 8, 2000.00);
